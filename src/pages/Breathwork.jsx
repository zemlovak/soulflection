      ...
      <div className="w-full h-auto bg-cyan-dark rounded-lg rounded-tl-none px-6 py-4 relative text-white">
        <div className="text-sm w-3/4 my-2">
          <p className="text-lg mb-2">
            <FontAwesomeIcon icon={faLightbulb} className="mr-2" /> Breathing
            exercises are simple techniques that help you take control of your
            breath.
          </p>
          <p>
            When we're stressed or anxious, our breath usually speeds up, which
            can actually make us feel more anxious. But doing some focused
            breathing can help interrupt the cycle in a way that naturally calms
            your body and mind.
          </p>
        </div>
          ...
          {filteredExercises.map((exercise) => {
            ...
            return (
              <div key={exercise.title}>
                ...
                >
                  <p className="font-light col-span-9">{exercise.title}</p>

                  <button
                    className="rounded-full col-span-2 min-w-16 max-w-24 bg-cyan-light px-4 py-1 text-white text-sm"
                ...
                >
                  {isExpanded && (
                    <>
                      <div className="italic text-sm mb-4 p-4 border border-white border-opacity-15 rounded-lg">
